...
function Luxt1.CreateWindow(libName, logoId)
    ...
    key1.Text = "LeftAlt"
    key1.TextColor3 = Color3.fromRGB(180, 255, 255)
    ...
    keybindInfo1.TextColor3 = Color3.fromRGB(180, 255, 255)
    ...
    hubName.TextColor3 = Color3.fromRGB(180, 255, 255)
    ...
    usename.TextColor3 = Color3.fromRGB(180, 255, 255)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(180, 255, 255)
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(180, 255, 255)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                TextButton.TextColor3 = Color3.fromRGB(180, 255, 255)
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    toggleInfo.TextColor3 = Color3.fromRGB(180, 255, 255)
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        key.Text = oldKey
                        key.TextColor3 = Color3.fromRGB(180, 255, 255)
                        key.TextSize = 14.000
                        ...
                        keybindInfo.TextColor3 = Color3.fromRGB(180, 255, 255)
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            textboxInfo.TextColor3 = Color3.fromRGB(180, 255, 255)
                            ...
                            TextBox.Text = ""
                            TextBox.TextColor3 = Color3.fromRGB(180, 255, 255)
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                sliderbtn.Text = ""
                                sliderbtn.TextColor3 = Color3.fromRGB(180, 255, 255)
                                ...
                                dragPrecent.Text = "0%"
                                dragPrecent.TextColor3 = Color3.fromRGB(180, 255, 255)
                                ...
                                sliderInfo.TextColor3 = Color3.fromRGB(180, 255, 255)
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    dropdownItem1.TextColor3 = Color3.fromRGB(180, 255, 255)
                                    ...
                                    for i,v in next, list do
                                        ...
                                        optionBtn1.Text = "  "..v
                                        optionBtn1.TextColor3 = Color3.fromRGB(180, 255, 255)
